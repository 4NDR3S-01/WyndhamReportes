...
class ReportesMedico extends Page
{
    ...
    // ============================================================
    // Kardex mensual (generado en memoria)
    // ============================================================
    public string $mes;
    ...
    public function cerrar(): void
    {
        ...
        $this->cerrado = true;
        Notification::make()->title('Kardex cerrado (no se modificar&aacute;)')->success()->send();
    }
    ...
    // ============================================================
    // Kardex mensual — exportar desde generador en memoria
    // ============================================================
