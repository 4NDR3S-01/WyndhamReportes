        ...
        <section class="grid gap-6 xl:grid-cols-[1fr_360px]">
            <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:p-8">
                <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Usa el archivo Excel del Departamento Medico con las hojas PARTES DIARIO y KARDEX.</p>
                    </div>
                ...
                <form wire:submit.prevent="subirDatos" class="space-y-6">
                    <label for="archivo" class="group relative block cursor-pointer rounded-3xl border-2 border-dashed border-sky-200 bg-sky-50/40 p-8 text-center transition hover:border-sky-400 hover:bg-sky-50 dark:border-sky-900 dark:bg-sky-950/20 dark:hover:border-sky-700">
                        ...
                        <div class="mt-5">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Excel: .xlsx, .xls</p>
                        </div>
            ...
            <aside class="space-y-6">
                <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="mt-5 space-y-4">
                        <div class="flex gap-3">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300">Debe contener la hoja <strong>PARTES DIARIO</strong> con columnas: FECHA, NOMBRES, AREA, CARGO, CAUSA, DIAGNOSTICO.</p>
                        </div>
                        <div class="flex gap-3">
                            <span class="mt-1 h-2 w-2 rounded-full bg-sky-500"></span>
                            <p class="text-sm text-gray-600 dark:text-gray-300">Debe contener la hoja <strong>KARDEX 2026</strong> con el inventario mensual de medicinas y equipos.</p>
                        </div>
                        <div class="flex gap-3">
                            <span class="mt-1 h-2 w-2 rounded-full bg-sky-500"></span>
                            <p class="text-sm text-gray-600 dark:text-gray-300">Formatos permitidos: Excel (.xlsx, .xls).</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    @php
                        $ultimo = \App\Models\MedicoArchivoImportado::query()
            ...
            <section class="rounded-3xl border border-sky-200 bg-white shadow-sm dark:border-sky-900 dark:bg-gray-900">
                <div class="border-b border-sky-100 px-6 py-5 dark:border-sky-900 sm:px-8">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-950 dark:text-white">Vista previa del archivo — PARTES DIARIO</h3>
            ...
            <div class="border-b border-gray-100 px-6 py-5 dark:border-gray-800 sm:px-8">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Registro reciente de documentos cargados al modulo de medico.</p>
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                @foreach ($this->historialArchivos as $archivoHistorial)
                                    <tr class="transition hover:bg-sky-50/50 dark:hover:bg-sky-950/20">
                                        ...
                                        <td class="px-6 py-4">
                                            @php
                                                $estadoEsProcesado = str_starts_with($archivoHistorial->estado, 'procesado');
                                                $estadoEsError = $archivoHistorial->estado === 'error';
                                            @endphp
                                            <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ring-1
                                                {{ $estadoEsProcesado ? 'bg-emerald-50 text-emerald-700 ring-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-300 dark:ring-emerald-900' : '' }}
                                                {{ $estadoEsError ? 'bg-red-50 text-red-700 ring-red-100 dark:bg-red-950/40 dark:text-red-300 dark:ring-red-900' : '' }}
                                                {{ !$estadoEsProcesado && !$estadoEsError ? 'bg-gray-100 text-gray-600 ring-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:ring-gray-700' : '' }}
                                            ">
