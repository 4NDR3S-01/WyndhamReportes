<x-filament-panels::page>
    ...
    <div class="page-enter mb-4">
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <x-stat-card title="Total productos" :value="number_format($this->totalProductos, 0, ',', '.')" icon="heroicon-o-cube" color="ocean" />
            <x-stat-card title="Medicinas" :value="number_format($this->totalMedicinas, 0, ',', '.')" icon="heroicon-o-clipboard-document-list" color="palm" />
            <x-stat-card title="Insumos" :value="number_format($this->totalInsumos, 0, ',', '.')" icon="heroicon-o-wrench-screwdriver" color="tide" />
